...
export default function GenerateTestPage() {
  ...
  const [adTests, setAdTests] = useState<
    Database["public"]["Tables"]["ad_tests"]["Row"][]
  >([]);
        ...
        <div className="max-w-7xl mx-auto p-4">
          ...
          <div className="space-y-4">
            {adExperiments
              .filter(
                (experiment) =>
                  experiment.flow == "Generation" ||
                  experiment.flow == "Testing"
              )
              .map((experiment) => (
                <Card
                  key={experiment.id}
                    ...
                    <div className="flex items-start space-x-4">
                      <div className="w-24 h-24 flex-shrink-0 rounded-md overflow-hidden bg-gray-100 flex items-center justify-center">
                        {experiment.ad_content?.image ? (
                          <Image
                            src={
                              typeof experiment.ad_content.image === "string"
                                ? experiment.ad_content.image
                                : URL.createObjectURL(
                                    experiment.ad_content.image
                                  )
                      ...
                      <div className="flex-grow">
                        ...
                        <div className="flex flex-wrap gap-2 text-xs text-gray-500 mb-3">
                          <div className="flex items-center">
                            ...
                            {experiment.target_audience?.location ||
                              "No location"}
                          </div>
                          <div className="flex items-center">
                        ...
                        <div className="flex justify-between items-center">
                          <div className="flex space-x-2">
                            <Badge
                              variant="outline"
                              className={`text-xs ${
                                experiment.version_data?.versions?.length ||
                                0 > 0
                                  ? "bg-blue-500 text-white"
                                  : ""
                              }`}
                            >
                              {experiment.version_data?.versions?.length || 0}{" "}
                              Versions
                            </Badge>
