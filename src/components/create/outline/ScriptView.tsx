...
const ScriptView: React.FC<ScriptViewProps> = ({ outlineElements, handleDeleteElement, outline_id, setOutlineElements }) => {
  ...
  const handleAddTransition = async (index: number) => {
    ...
    try {
      ...
      const updateResponse = await fetch("/api/create/outlines/update-elements", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleGenerateSuggestion = async (elementId: string, type: 'instructions' | 'description' | 'sources') => {
    try {
      ...
      const response = await fetch(`/api/create/outlines/generate-${type}-suggestion`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
      ...
      const updateResponse = await fetch("/api/create/outlines/update-element", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
