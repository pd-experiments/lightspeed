...
import TopAdvertisers from '@/components/dashboard/ads/TopAdvertisers';
import RecentAds from '@/components/dashboard/ads/RecentAds';
import AdFormats from '@/components/dashboard/ads/AdFormats';
...
export default function AdsDashboardPage() {
  ...
  const fetchTopAdvertisers = async () => {
    try {
      const response = await fetch('/api/dashboard/ads/top-advertisers');
  ...
  const fetchRecentAds = async () => {
    try {
      const response = await fetch('/api/dashboard/ads/recent-ads');
      const data = await response.json();
      setRecentAds(data);
    } catch (error) {
  ...
  const fetchAdFormats = async () => {
    try {
      const response = await fetch('/api/dashboard/ads/ad-formats');
      const data = await response.json();
      setAdFormats(data);
    } catch (error) {
  ...
  const fetchAgeTargeting = async () => {
    try {
      const response = await fetch('/api/dashboard/ads/age-targeting');
      const data = await response.json();
  ...
  const fetchGenderTargeting = async () => {
    try {
      const response = await fetch('/api/dashboard/ads/gender-targeting');
      const data = await response.json();
